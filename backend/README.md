...
## Project Structure
    ...
    ├── hotel_loyalty_app_37434  # Django project configurations
...
1. Clone this repo and `cd hotel_loyalty_app_37434`
...
2. Clone this repo and `cd hotel_loyalty_app_37434`
